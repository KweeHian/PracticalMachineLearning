...
# print tuning parameters it choosen in final model
modFit$finalModel
```
...
predictions <- predict(fitData, newdata=rawTrainData2)
...
As the model take a long time to generate, the model output are only show in pdf file.
